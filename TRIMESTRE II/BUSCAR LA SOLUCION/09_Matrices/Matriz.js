...
fila=document.getElementById('escogida').value;

    //  var nota1=parseFloat(datos[fila][4])
    //  var nota2=parseFloat(datos[fila][5])
    //  var nota3=parseFloat(datos[fila][6])
    //  var nota4=parseFloat(datos[fila][7])
    //  promedio =(nota1+nota2+nota3+nota4)/4
    //  document.write("Hola "+datos[fila][1]+" con carrera "+datos[fila][2] +" su promedio es de "+"("+promedio+")");
